...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.genesis.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.genesis.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.genesis.releasetype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "genesis.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "genesis.updater.uri";
    public static final String PROP_UPDATER_ALLOW_MAJOR_UPDATE = "genesis.updater.allow_major_update";
